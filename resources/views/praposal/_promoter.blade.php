            ...
            <div class="col-md-12">
                <div class="tab-content tab-design">
                    <div class="btn-group leftside_tab" data-toggle="tab" style="padding-left: 10px;">
                        ...
                        <a id="lnkLoanDtls2" href="#" class="btn btn-large btn-success btn-space disabled">Other Details</a>
                        <a id="lnkLoanDtls3" href="#" class="btn btn-large btn-success btn-space disabled">Financial Details</a>
                    </div>
                                                ...
                                                {!! Form::textarea('promoters['.$formIndex.'][kyc_address]',
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        {!! Form::select('promoters['.$formIndex.'][kyc_state]',$states,
                                                            ...
                                                            'form-control', 'style' => 'width: 100%;',  $setDisable]) !!}
                                                            @endif
                                                        </div>
                                                        @endif
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <label class="radio-inline">
                                                                        {!! Form::radio('othr_noofindependent', $noOfFamilyTypeName,['data-mandatory'=>'M',$setDisable])!!}
                                                                        {{$noOfFamilyTypeValue}}
                                                                    </label><br>
                                                                    @endforeach
                                                                </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group" style="margin-left: auto;">
                                                                                        ...
                                                                                        {!! Form::select('fin_vehiclesowned', array('' => 'Select Vehicle','1' => '1', '2' => '2 to 4', '3' =>'Greater than 4') , null , ['id' => 'isvehicleold','class'=>'form-control',$setDisable]) !!}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group" style="margin-left: auto; margin-right: auto;">
                                                                                        ...
                                                                                        {!! Form::text('fin_vehiclesowned_marketvalue', null , ['class' =>'form-control amount', 'id'=>'apprx_market_value_vehicle','placeholder'=>'Market Value of vehicle ( Lacs )',$setDisable]) !!}
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                    ...
                                                                                    <div class="row" style="margin-left: auto;">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="form-group" style="margin-left: auto;">
                                                                                                ...
                                                                                                <label class="radio-inline">
                                                                                                    {!! Form::radio('propertyDetails['.$formIndex.'][is_mortgage]', 'Yes',true,['id' => 'mortgage_radio_radio_option_1','data-mandatory'=>'M',$setDisable]) !!}
                                                                                                    Yes
                                                                                                </label>
                                                                                                <label class="radio-inline">
                                                                                                    {!! Form::radio('propertyDetails['.$formIndex.'][is_mortgage]', 'No',false, ['id' => 'mortgage_radio_radio_option_2','data-mandatory'=>'M',$setDisable]) !!}
                                                                                                    No
                                                                                                </label>
