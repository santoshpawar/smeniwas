                    ...
                    <div style="padding: 10px;">
                      <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                          ...
                          @else
                          {!! Form::label('','From Period for Month/Year') !!}
                          {!! Form::text('bank_period'.$formindex, null, ['class' => 'form-control','id'=>'fromDateStat', 'size' => '5x5',$setDisable]) !!}
                          @endif
                        </div>
                        <div class="col-sm-6 col-lg-3">
                          @if(isset($model['bank_period'.$formindex]))
                          ...
                          @else
                          {!! Form::label('','To Period for Month/Year') !!}
                          {!! Form::text('bank_period'.$formindex, null, ['class' => 'form-control','id'=>'toDateStat', 'size' => '5x5',$setDisable]) !!}
                          @endif
                        </div>
                      </div>
                      <div class="row">
