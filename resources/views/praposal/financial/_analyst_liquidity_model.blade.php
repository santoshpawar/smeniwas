            ...
            <div id="credit_model" style="padding: 5px;">
             ...
             <td style="width: 22%;">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @if($dimensionCounter=='16' || $dimensionCounter=='20' || $dimensionCounter=='21')
                    {!! Form::select('liquidity_model_rating_details['.$dimensionCounter.'][measure_id_label]', $creditDimension->measures->lists('label', 'id')->all(), $creditDimension->selected_measure_id, ['id' => 'measureValue_'.$dimensionCounter, 'class' => 'form-control', 'style' => 'width: 100%;border: 2px solid #9cbd31;' ]) !!}
                    @else
                    {!! Form::select('liquidity_model_rating_details['.$dimensionCounter.'][measure_id_label]', $creditDimension->measures->lists('label', 'id')->all(), $creditDimension->selected_measure_id, ['id' => 'measureValue_'.$dimensionCounter, 'class' => 'form-control', 'style' => 'width: 100%;' ]) !!}
                    @endif
