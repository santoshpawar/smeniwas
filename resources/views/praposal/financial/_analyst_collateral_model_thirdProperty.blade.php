...
<div class="card">
   <div class="card-header" data-background-color="green">
     <h4 class="title">Collatral Model :  Property 3  <span class="pull-right">{{ $userProfile->name_of_firm }}</span></h4>
...
{{--
                ...
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::button('First Property', array('class' => 'btn btn-success btn-cons sme_button', 'onclick' => "showTab('Div11', '$loanType','$endUseList', $amount, $loanTenure, $loanId); return false;", 'value'=> 'Back', 'style' => 'margin-top:3px;' )) !!}
                        {!! Form::button('Second  Property', array('class' => 'btn btn-success btn-cons sme_button', 'onclick' => "showTab('Div13', '$loanType','$endUseList', $amount, $loanTenure, $loanId); return false;", 'value'=> 'Back', 'style' => 'margin-top:3px;' )) !!}
                        @if(Auth::user()->isSMENiwasEmployee())
