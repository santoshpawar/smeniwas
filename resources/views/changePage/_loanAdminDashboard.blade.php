            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="border:none;">
                 <!--  <a class="btn btn-success btn-cons sme_button pull-left" href="{{URL::to('/loans/index')}}" style='margin-top:10px;margin-bottom: 10px;'>Create New Loan</a>                   <a class="btn btn-success btn-cons sme_button pull-left" href="{{URL::to('/loans/wizard')}}" style='margin-top:10px;margin-bottom: 10px;'>Load Advisor</a> --> 
                  ...
                  <a class="btn btn-success btn-cons sme_button pull-left" href="{{URL::to('home/praposal')}}" style='margin-top:10px;margin-bottom: 10px;'>Create New Loanssssss</a>                  
              ...
              <td> 
                ...
                <td>
                  ...
                  <a href="{{URL::to('loans/praposal/createchecklist/'. $loan->type. '/' .$loan->end_use. '/' .$loan->loan_amount. '/' .$loan->loan_tenure. '/'. $loan->id)}}">  Create Checklistsss</a> 
