...
<div class="main-panel">
    ...
    {!! Form::model($parameterMasterData,['method' =>'POST','action' => $formaction] ) !!}

    <div class="container">
        <div class="btn-group leftside_tab" style="padding-bottom:10px;">
            <a href="{{URL::to("/admin/parameterdata")}}" class="btn btn-large btn-success btn-space" style="font-size: 14px !important;">Admin</a>
            <a href="#" class="btn btn-large btn-success btn-space active" style="font-size: 14px !important;">Manage Parameter Data</a>
        </div>
        ...
        <div class="tab-content tab-design responsive col-xs-12 col-md-8 col-lg-12" style="padding:20px;margin-bottom: 20px;">
            <div role="tabpanel" class="tab-pane active" id="registration">
                ...
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    {!! Form::hidden('id',null) !!}
                    {!! $errors->first('parameter_name','<span class="help-block">:message</span>') !!}
                    {!! Form::label('parameter_name','Model ', ['class' => '']) !!}
                    {!! Form::text('parameter_name',null,['class' => 'form-control','disabled' => 'true']) !!}
                </div>
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    {!! Form::hidden('id',null) !!}
                    {!! $errors->first('parameter_name','<span class="help-block">:message</span>') !!}
                    {!! Form::label('parameter_name','Name ', ['class' => '']) !!}
                    {!! Form::text('parameter_name',null,['class' => 'form-control','disabled' => 'true']) !!}
                </div>
                ...
                <div class="form-group {{ $errors->has('parameter_value') ? 'has-error' : '' }}">
                    {!! $errors->first('parameter_value','<span class="help-block">:message</span>') !!}
                    {!! Form::label('parameter_value','Value', ['class' => '']) !!}
                ...
                <div class="row">
                    ...
                    <a href="{{URL::to("/admin/parameterdata") }}" class="btn btn-success btn-cons sme_button" style="margin-top:20px;margin-left:20px;"><i class="fa fa fa-sign-out"></i> Exit</a>
                </div>
