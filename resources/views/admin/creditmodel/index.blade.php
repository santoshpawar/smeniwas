...
<div class="main-panel">
    ...
    <div class="content">
     <div class="card">
        ...
        <section style="margin-left: 50px;margin-right: 50px;">
            <?php
            $resultsTemplate = 'admin.creditmodel.categoriesresults';
            ?>
            <div class="panel-body">
                <table id="creditModelGrid" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Category</th>
                            <th>Description</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{URL::to('/admin/creditmodel/dimensions/' . $value->id)}}">{!! $value->label !!}</a></td>
                            ...
                            <td><a href="{{URL::to('/admin/creditmodel/edit-category/' . $value->id)}}">Edit</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    {{--@section('title', 'Manage Credit Model - Categories')--}}
    {{--@section('datasource',URL::to('/admin/creditmodel/categories-grid'));--}}
    {{--@section('extra-actions-post-grid-download')--}}
    {{--<li class="primary">--}}
        {{--<a href={{URL::to("/admin/creditmodel/create-category")}} data-toggle="tooltip" data-original-title="Create">--}}
    ...
    <script type="text/javascript">
      jQuery(document).ready(function($){
        ...
        var buttonLabel = $("#buttonLabel").html('<span class="navbar-brand">Manage Analyst Model - Categories</span>');
        var buttonPlaceholder = $("#buttonPlaceholder").html('<a href={{URL::to("/admin/creditmodel/create-category")}} style="margin-top:10px" title="Create New User" class="btn btn-sm btn-default"><i class="fa fa-plus"></i></a>');
