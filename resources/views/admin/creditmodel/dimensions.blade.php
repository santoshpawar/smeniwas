    ...
    <div class="content">
                ...
                <div class="panel-body">
                    <table id="dimensionsGrid" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{URL::to('admin/creditmodel/measures/' . $value->id . '/' .$categoryId)}}">{!! $value->label !!}</a></td>
                                ...
                                <td><a href="{{URL::to('/admin/creditmodel/edit-dimension/' . $value->id)}}">Edit</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var buttonLabel = $("#buttonLabel").html('<span class="navbar-brand">Manage Analyst Model - Dimensions</span>');
                var buttonPlaceholder = $("#buttonPlaceholder").html('<a href={{URL::to("/admin/creditmodel/create-dimension/$categoryId")}} style="margin-top:10px" title="Create New Dimension" class="btn btn-sm btn-default"><i class="fa fa-plus"></i></a>');
                var buttonBack = $("#buttonBack").html('<a href={{URL::to("/admin/creditmodel")}} title="Create" style="margin-top:10px" class="btn btn-sm btn-primary">Back</a>');
