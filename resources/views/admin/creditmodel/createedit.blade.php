  ...
  <div class="main-panel">
    ...
    <div class="container">
        <div class="btn-group leftside_tab" style="padding-bottom:10px;">
            <a href={{URL::to("/admin/creditmodel/dimensions/$categoryId")}} class="btn btn-large btn-success" style="font-size: 14px !important;">Admin</a>
{{--            <a href={{URL::to("/admin/creditmodel/dimensions/$categoryId")}} class="btn btn-large btn-info" style="font-size: 14px !important;">View Manage Credit Model - Dimensions</a>--}}
            <a href="#" class="btn btn-large btn-success active" style="font-size: 14px !important;">Dimensions</a>
        </div>
        {{--<ul class="breadcrumbs">--}}
            {{--<li><a href={{URL::to("/admin")}}>Admin</a></li>--}}
            {{--<li><a href={{URL::to("/admin/creditmodel/dimensions/$categoryId")}}>Manage Credit Model</a></li>--}}
        ...
        <div class="tab-content tab-design responsive col-xs-12 col-md-8 col-lg-12" style="padding:20px;margin-bottom: 20px;">
            <div role="tabpanel" class="tab-pane active" id="registration">
                ...
                <div class="row">
                    ...
                    <a href="{{URL::to("/admin/creditmodel/dimensions/$categoryId")}}" class="btn btn-success btn-cons sme_button" style="margin-top:20px;margin-left:20px;"><i class="fa fa-sign-out"></i>Exit</a>
                </div>
