...
<div class="main-panel">
                ...
                <table id="measuresGrid" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{URL::to('/admin/liquiditymodel/edit-measures/' . $value->id. '/' . $dimensionId . '/' . $categoryId)}}">Edit</a>
                                <a onclick="return deleteRecords($(this), 'Liquidity Model measure');") style="margin-left: 25px;" href="{{URL::to('/admin/liquiditymodel/delete-measures/' . $value->id)}}">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            ...
            var buttonLabel = $("#buttonLabel").html('<span class="navbar-brand">Manage Liquidity Model - Measures</span>');
            var buttonPlaceholder = $("#buttonPlaceholder").html('<a href={{URL::to("/admin/liquiditymodel/create-measures/$dimensionId/$categoryId")}} style="margin-top:10px" title="Create New Dimension" class="btn btn-sm btn-default"><i class="fa fa-plus"></i></a>');
            var buttonBack = $("#buttonBack").html('<a href={{URL::to("/admin/liquiditymodel/dimensions/$categoryId")}} title="Create" style="margin-top:10px" class="btn btn-sm btn-primary">Back</a>');
