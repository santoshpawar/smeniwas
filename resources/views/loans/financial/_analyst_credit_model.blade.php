                ...
                <table class="table table-bordered">
                 ...
                 <div class="row">
                    ...
                    <tr>
                       ...
                       <td>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            {!! Form::select('analyst_model_rating_details['.$dimensionCounter.'][is_applicable]', $yesNoOptions, $creditDimension->is_applicable, ['id' => 'applicable_'.$dimensionCounter, 'class' => 'form-control', 'style' => 'width: 100%;']) !!}
                        </div>
                    </td>
                    <td>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            {!! Form::select('analyst_model_rating_details['.$dimensionCounter.'][measure_id]', $creditDimension->measures->lists('label', 'id')->all(), $creditDimension->selected_measure_id, ['id' => 'measureValue_'.$dimensionCounter, 'class' => 'form-control', 'style' => 'width: 100%;']) !!}
                        </div>
                    </td>
                    @endif
                    <td>
