      ...
      <div id="tab" class="btn-group leftside_tab" role="group">
        ...
        <ul class="nav">
         ...
         <li>
           ...
           <a style="width:100%;" href="{{{URL::to('loans/bank-approval/'.$loanType.'/'.$endUseList.'/'.$amount.'/'.$loanTenure.'/'.$loanId)}}}" class="btn btn-large btn-success btn-space lefttabbtn {{{$sub_view_type == "loans.bank._bank_approval" ? 'active' : ''}}} " role="button"><i class="material-icons">account_balance</i>Bank Approval</a>
           @endif
         </li>
       </ul>
     </div>
