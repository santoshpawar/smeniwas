  ...
  <div class="row">
    <div class="card">
      <div class="card-header" data-background-color="green">
        <h4 class="title">Upload Documents <span class="pull-right">{{ $userProfile->name_of_firm }}</span></h4>
      ...
      <div class="card-content">
        <div class="tab-content tab-design" style="padding-top:20px;">
          <div class="btn-group leftside_tab" data-toggle="tab" style="margin-left:10px;">
            <a id="lnkLoanDtls1" href="#" class="btn btn-large btn-success btn-space active" style="font-size: 14px !important;">Business KYC & Financials</a>
          ...
          <div id="divTab_sub1" class="collapse" style="margin-left:25px;margin-right:25px;">
            ...
            <div class="alert alert-default comppress"  role="alert"><span style="width: ">  Before you upload Convert and Compress PDF files 
             ...
             <div id="" class="panel panel-success">
              ...
              <div class="panel-heading">Please select documnets that you can upload</div>
              <br>
              <div class="col-sm-12">
                <div class="col-md-3">
                  <input type="checkbox" class="securityColl-input" name="finacial" value="finacial" id="uploadFinancial">
                  <label for="inputFinancials Reports/Balance Sheets ">Financials Reports</label>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                  ...
                  <label for="inputKYC Details (Mandatory) ">KYC Details</label>
                </div>
              </div>
              <br><br>
            </div>
                    ...
                    <div style="padding: 10px;">
                      <div class="row">
                        <div class="col-sm-12 col-lg-6">
                          ...
                          {!! Form::text('bank_name'.$formindex, $model['bank_name'.$formindex], ['class' => 'form-control', 'size' => '5x5','data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                          @else
                          {!! Form::label('','Name of Bank') !!}
                          {!! Form::text('bank_name'.$formindex, null, ['class' => 'form-control', 'size' => '5x5','data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                          @endif
                        </div>
                        <div class="col-sm-6 col-lg-3">
                          @if(isset($model['bank_period'.$formindex]))
                          {!! Form::label('','From Period for Month/Year ') !!}
                          {!! Form::text('bank_period'.$formindex, $model['bank_period'.$formindex], ['class' => 'form-control', 'id'=>'fromDateStat','size' => '5x5',$setDisable]) !!}
                          @else
                          {!! Form::label('','From Period for Month/Year') !!}
                          {!! Form::text('bank_period'.$formindex, null, ['class' => 'form-control','id'=>'fromDateStat', 'size' => '5x5','data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                          @endif
                        </div>
                        <div class="col-sm-6 col-lg-3">
                          @if(isset($model['bank_period'.$formindex]))
                          {!! Form::label('','To Period for Month/Year ') !!}
                          {!! Form::text('bank_period'.$formindex, $model['bank_period'.$formindex], ['class' => 'form-control', 'id'=>'toDateStat','size' => '5x5',$setDisable]) !!}
                          @else
                          {!! Form::label('','To Period for Month/Year') !!}
                          {!! Form::text('bank_period'.$formindex, null, ['class' => 'form-control','id'=>'toDateStat', 'size' => '5x5','data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                          @endif
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-12 col-lg-6">
                          ...
                          {!! Form::file('bank_file'.$formindex.'_path', ['class' => 'form-control upload_details','id'=>'bank_file'.$formindex.'_path','data-mandatory'=>''.$mandatoryField.'' ,$setDisable] ) !!}
                          @if(isset($cmpnybankstmt_file['bank_file'.$formindex.'_path']))
                          <input type="hidden" name="text" value="22" id="openCloseBankStat">
                    ...
                    <div style="padding: 10px;">
                      <div class="row">
                        <div class="col-sm-12 col-lg-6">
                          ...
                          <input type="hidden" name="text" value="33" id="openCloseUpCibil">
                          @endif
                        </div>
                      </div>
                    </div>
                    ...
                    <div style="padding: 10px;">
                      ...
                      <div class="row">
                        <div class="col-sm-12 col-lg-6">
                          ...
                          {!! Form::label(null,$removeMandatory, ['style' => 'color: red;']) !!}
                          {!! Form::file('kycDetails[1][kyc_extra_file1_path]', ['class' => 'form-control upload_details','id'=>'optional_file1',$setDisable]) !!}
            ...
            <div id="divTab_sub2" class="collapse" style="margin-left:25px;margin-right:25px;">
                      ...
                      <div class="row">
                        <div class="col-sm-12 col-lg-6">
                          ...
                          <div id="Que39" class="">
                            {!! Form::label('AssetsFA', 'Bank Statements') !!}
                            {!! Form::file('prom_bank_stmt_file_path', ['class' => 'form-control
                            upload_details','id'=>'bankstatement_file','data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                          </div>
                          @endif
                          @if(isset($bankstatement_file))
                          <input type="hidden" name="text" value="221" id="openClosePromBank">
                    ...
                    <div style="padding: 10px;">
                      <div class="row">
                        <div class="col-sm-12 col-lg-6">
                          ...
                          {!! Form::file('prom_networth_file_path', ['class' => 'form-control upload_details','id'=>'promoternetworth_file','data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                          {!! Form::hidden('networth_file_check', 0, array('id' => 'networth_file_check')) !!}
                          @if(isset($promoternetworth_file))
                          <input type="hidden" name="text" value="222" id="openClosePromFin">
              ...
              <fieldset class="f2upKyc">
                ...
                <div id="divTab_sub3" class="collapse" style="margin-left:25px;margin-right:25px;">
                  <div id="" class="panel panel-success">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="col-md-4">
                        ...
                        <label for="Bank Statement">Invoice/Bill details</label>
                      </div>
                    </div>
                    <br><br>
                  </div>
                      ...
                      <div style="padding: 10px;">
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-lg-6">
                            ...
                            'id'=>'corporate_file','data-mandatory'=>''.$mandatoryField.'' ,$setDisable],$setDisable) !!}
                            @if(isset($corporate_file))

                            <input type="hidden" name="text" value="321" id="openCloseBizCor">
                  ...
                  <!-- start F3.3 -->
                  <fieldset class="f3upEquipment">
                    <div id="equipcopy">
                      @for($i=1; $i < $maxInvoiceCopyofEquipmentPurchase; $i++)
                      @if($i == 1)
                      <div id="EquipCopy_{{$i}}" class="panel panel-success">
                        <div class="panel-heading">Invoice Copy of Equipment Purchase</div>
                        @else
                        <div id="EquipCopy_{{$i}}" class="panel panel-success collapse">
                          ...
                          <div class="row" style="padding: 10px;">
                            <div class="col-sm-12 col-lg-6">
                              {!! Form::label('', 'Upload File') !!}
                              {!! Form::label(null,$removeMandatory, ['style' => '  color: red;']) !!}
                              {!! Form::file('equipementPurchase[business_invoice_equi'.$i.'_file_path]', ['class' => 'form-control upload_details', 'id'=>'equipementcopy_file_'.$i ,'data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                              ...
                              <input type="hidden" name="text" value="322" id="openCloseBizInvEq">
                          ...
                          <div id="InvCopy_<?php echo $i; ?>" class="panel panel-success collapse">
                            ...
                            <div class="row" style="padding: 10px;">
                              <div class="col-sm-12 col-lg-6">
                                {!! Form::label('', 'Upload File') !!}
                                {!! Form::label(null,$removeMandatory, ['style' => '  color: red;']) !!}
                                {!! Form::file('invoiceBillFile[business_invoice_bill'.$i.'_file_path]', ['class' => 'form-control upload_details', 'id'=>'invoicecopy_file_'.$i,'data-mandatory'=>''.$mandatoryField.'' ,$setDisable]) !!}
                                ...
                                <div class="row">
                                  <div class="col-sm-12 col-lg-6">
                                    <div id="Que46" class="">
                                      ...
                                      {!! Form::file('electricity_bill[electricity_bill_'.$i.'_path]', ['class'=> 'form-control upload_details','id'=>'electricity_bill_'.$i,$setDisable]) !!}
                                    </div>
