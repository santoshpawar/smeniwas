...
class LiquidityModelCategory extends Model {
    public $table = "liquidity_model_categories";
    ...
    public function dimensions(){
        return $this->hasMany('App\Models\Loan\LiquidityModel\LiquidityModelDimension','category_id','id')->where('status','=','1');
    }
    ...
    private static function fetchLiquidityModelCategory($keyName, $addEmptyFirstElement=true){
        ...
        if(Cache::has($keyName)){
            ...
            $categoryData = LiquidityModelDimension::where('label', "=", $keyName)->lists('label','weight')->all();
